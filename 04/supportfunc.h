...
A_ID *setDelcaratorKind(A_ID *, ID_KIND);
A_ID *setDelcaratorType(A_ID *, A_TYPE*);
A_ID *setDelcaratorElementType(A_ID *, A_TYPE *);
A_ID *setDelcaratorTypeAndKind(A_ID *, A_TYPE *, ID_KIND);
